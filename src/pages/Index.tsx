            ...
            <div className="col-span-12 grid grid-cols-2 gap-6 lg:col-span-5 lg:grid-rows-2">
              ...
              >
                <div className="flex items-center gap-3">
                  <img src={rcaTeamLogo} alt="RCA Team logo" className="h-11 w-11 rounded-full border border-border/70 object-cover" loading="lazy" />
                  <img src={gauravPhoto} alt="Gaurav" className="h-11 w-11 rounded-full border border-border/70 object-cover" loading="lazy" />
                </div>
                <p className="mt-14 text-lg font-bold text-foreground">Creator Team</p>
                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Real-time Sync</p>
              </motion.div>
            </div>
          </div>
        </section>
